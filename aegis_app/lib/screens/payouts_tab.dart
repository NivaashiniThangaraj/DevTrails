...
class _PayoutsTabState extends State<PayoutsTab> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Consumer<AegisProvider>(builder: (_, prov, __) {
      ...
      return RefreshIndicator(
        onRefresh: prov.fetchClaims,
        color: AppColors.blue,
        child: SingleChildScrollView(
          physics: const AlwaysScrollableScrollPhysics(),
          child: Column(children: [
            _buildHero(context, worker, claims),
            Padding(
  ...
  Widget _buildHero(BuildContext context, worker, List<Claim> claims) {
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              ...
              Text('${worker?.planTier ?? 'Standard'} · Active',
                style: GoogleFonts.nunito(
          ...
          Container(width: 36, height: 36,
            ...
            child: Center(child: Text(
              worker?.name.isNotEmpty == true ? worker!.name[0].toUpperCase() : 'S',
        ...
        Padding(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
            _heroStat('Plan', '₹${worker?.weeklyPremium.toInt() ?? 0}'),
            _heroDivider(),
            _heroStat('Total paid', '₹${totalPaid.toInt()}'),
            _heroDivider(),
            _heroStat('Claims', '${claims.length}'),
          ]),
        ),
      ]),
    );
  ...
  Widget _buildPayoutHistory(List<Claim> claims) {
    ...
    return AppCard(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        ...
        Text('Total: ₹${claims.where((c) => c.status == ClaimStatus.paid).fold(0.0, (s,c)=>s+c.amount).toInt()}',
          style: GoogleFonts.nunito(
