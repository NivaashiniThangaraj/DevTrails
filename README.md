...
> 🚀 **Live web demo (frontend only):** https://nivaashinithangaraj.github.io/DevTrails/ —
> the Flutter app deployed to GitHub Pages. The deployed demo runs entirely on
> **hardcoded sample data** (no backend required). Build/deploy details are in
> [`aegis_app/README.md`](aegis_app/README.md).
